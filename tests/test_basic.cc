...
int main() {
    ...
    VGP_LOGN(Level::DEBUG, "5 This is a debug message with time: {}", arr);
    VGP_INFO("4 This is a info message with time\n");
    VGP_LOGN(Level::ERROR, "2 This is a warn message with time");

    // 切换到默认格式
    vgp::Logger::GetInstance().SetFormat(vgp::Logger::Format::kFull);
    VGP_LOGN(Level::FATAL, "1 This is an error message with default format");
    ...
    VGP_LOGFN(Level::ERROR, "2 This is a warning message in file");
    vgp::Logger::GetInstance().SetFormat(vgp::Logger::Format::kMedium);
    VGP_LOGFN(Level::DEBUG, "5 This is a debug message in file with time");
    VGP_LOGF(Level::INFO, "4 This is a info message in file with time\n");
    VGP_LOGFN(Level::WARN, "2 This is a warn message in file with time");
   ...
   // print to console
    ...
    VGP_CLOGFN(Level::INFO, "this is one compile log in file");
